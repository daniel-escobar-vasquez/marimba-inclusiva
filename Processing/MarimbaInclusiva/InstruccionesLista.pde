...
class InstruccionesLista
{
  ...
  InstruccionesLista ( )
  {
    ...
    instruccionSeleccionarModo     =  new Instruccion ( "  SELECCIONA;    EL MODO;   DE JUEGO" , 25000 , null, true );
    ...
    instruccionTocarLibre          =  new Instruccion ( "TOCA LIBREMENTE" , 2500 , null, false );
    ...
    instruccionMemorizarSecuencia  =  new Instruccion ( "   MEMORIZA;      LA;   SECUENCIA" , 2000 , null, true );
    instruccionRepetirSecuencia    =  new Instruccion ( "    REPITE;      LA;     SECUENCIA" , 2000 , imgInstJuego, true );
    instruccionIntentarNuevamente  =  new Instruccion ( " " , 25000 , imgIncorrecto, true );
    ...
    instruccionSecuenciaLograda    =  new Instruccion ( " " , 25000 , imgCorrecto, true );
    ...
    instruccionSiguienteSecuencia  =  new Instruccion ( "  " , 10 , null, true );
